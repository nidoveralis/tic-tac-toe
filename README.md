...
3. Противник реализует базовый алгоритм для выполнения ходов. Он анализирует текущее состояние доски и выбирает наилучший возможный ход, чтобы максимизировать свои шансы на победу или заблокировать победу игрока-человека.
